...
// Somewhere in your code where the error is occurring
async function someFunction() {
  try {
    // Call the async function that throws the error
    await someAsyncFunction();
  } catch (error) {
    // Handle the error gracefully, you can do whatever you want here
